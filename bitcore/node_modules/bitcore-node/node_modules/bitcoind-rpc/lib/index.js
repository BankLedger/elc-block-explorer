  ...
  var req = this.protocol.request(options, function(res) {
	    ...
	    res.on('end', function() {
	      ...
	      try{
	    	  	...
	    	  	console.log("rpc call back error:"+request+" callBack:"+callback+" message:"+e.message+" data:"+JSON.stringify(parsedBuf));
	    	  	throw e;
	      }
	  ...
	  req.on('error', function(e) {
		e.message=request+" "+e.message;
	    var err = new Error(errorMessage + 'Request Error: ' + e.message);
	    console.log("rpc  called error:"+e.message);
	    if (!called) {
	      called = true;
	      callback(err);
	    }
