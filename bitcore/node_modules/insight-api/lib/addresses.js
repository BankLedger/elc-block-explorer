...
AddressController.prototype.getAddressSummary = function(address, options, callback) {
  ...
  this.node.getAddressSummary(address, options, function(err, summary) {
    ...
    var transformed = {
      ...
      balanceSat: parseFloat(summary.balance.toFixed(8)),
      totalReceived: summary.totalReceived / 1e8,
      totalReceivedSat: parseFloat(summary.totalReceived.toFixed(8)),
      totalSent: summary.totalSpent / 1e8,
      lockedValue: parseFloat(summary.lockedValue),
      unspendValue: (parseFloat(summary.balance.toFixed(8)) - parseFloat(summary.lockedValue.toFixed(8))).toFixed(8),
